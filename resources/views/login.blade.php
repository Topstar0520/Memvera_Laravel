...
<html lang="en">
  <head>
    ...
    <title>Memvera Marketing Campaign</title>
  ...
  <body>
    <form class="form-signin" method="POST" action="{{ route('login.perform') }}">
        @csrf
      <div class="text-center mb-4">
        <div class="flex justify-center pt-2 sm:justify-start sm:pt-0">
            <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-gray-700 sm:h-20"  style="width: 200px;">
